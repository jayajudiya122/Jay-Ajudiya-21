...
class GearSystem {
    ...
    createGears() {
        const gearCount = Math.floor(window.innerWidth / 150);
        ...
        for (let i = 0; i < gearCount; i++) {
            this.gears.push({
                ...
                strokeColor: `rgba(0, 212, 255, ${Math.random() * 0.5 + 0.3})`
            });
        }
    }

    drawGear(gear) {
        const { x, y, radius, teeth, rotation, color, strokeColor } = gear;
    ...
    animate() {
        ...
        this.gears.forEach((gear, index) => {
            ...
            // Mouse interaction - gears slow down when mouse is near
            ...
            if (distance < 150) {
                ...
                gear.rotationSpeed *= (1 - force * 0.5);
            }
            
            // Draw gear
            this.drawGear(gear);
            
            // Connect nearby gears with lines
